...
export function PlayerSelectionPanel({ video, onDone }: { video: Video; onDone: () => void }) {
  ...
  return (
    <div className="border border-[var(--warning)]/40 bg-[var(--warning-soft)] rounded-xl p-5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        {persons.map((p) => (
          <div key={p.id} className="bg-[var(--surface)] border border-[var(--separator)] rounded-lg p-3 text-center">
            <div className="h-16 flex items-center justify-center">
              <div
                className="bg-[var(--accent-soft)] border border-[var(--accent)] rounded"
                style={{
            ...
            <button
              ...
              className="w-full text-xs bg-[var(--accent)] text-white rounded-md py-1.5 font-medium disabled:opacity-50 hover:bg-[var(--accent-pressed)]"
            >
            ...
            <button
              ...
              className="w-full text-xs mt-1 border border-[var(--separator-strong)] text-[var(--text-secondary)] rounded-md py-1.5 hover:bg-white/5"
            >
              This is my partner
            </button>
          </div>
